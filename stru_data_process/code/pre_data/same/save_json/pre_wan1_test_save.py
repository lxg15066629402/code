...
def compare_double(folders):
    ...
    if len(doctor_name) == 2:
        ...
        error_data.append(folders)
    return png_dic, all_nii_dic, error_data
...
def main():
    ...
    # 01
    save_png_path = '/dicom/Jone/code/data_pre/stru_data_process/same/wan1_json1_test/data'
    save_json_path = '/dicom/Jone/code/data_pre/stru_data_process/same/wan1_json1_test/annotations'
    mask_png_path = '/dicom/Jone/code/data_pre/stru_data_process/same/wan1_json1_test/ann'
    ...
    for doctor in sorted(os.listdir(dcm_folders)):
        ...
        png_dic, all_nii_dic, error_data = compare_double(patient_path)
