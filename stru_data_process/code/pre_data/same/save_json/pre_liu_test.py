...
def main():
    ...
    # 01
    # save_png_path = '/dicom/Jone/code/data_pre/stru_data_process/same/liu_json1/data'
    # save_json_path = '/dicom/Jone/code/data_pre/stru_data_process/same/liu_json1/annotations'
    # mask_png_path = '/dicom/Jone/code/data_pre/stru_data_process/same/liu_json1/ann'
    ...
    for doctor in sorted(os.listdir(dcm_folders)):
        ...
        png_dic, all_nii_dic = get_double(patient_path)
